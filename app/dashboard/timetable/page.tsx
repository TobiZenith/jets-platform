      ...
      <div className="flex">
        ...
        <div className="flex-1 p-8">
          <div className="mb-8">
            ...
            <p className="text-gray-400 text-sm mt-1">Manage class schedules and timetables</p>
          </div>

          <div className="bg-white rounded-2xl shadow-sm p-12 text-center">
            <div className="text-5xl mb-4">🗓️</div>
            <h3 className="text-lg font-bold text-gray-800 mb-2">Timetable Management</h3>
            <p className="text-gray-400 text-sm">Coming soon — class schedules and timetable management</p>
          </div>
        </div>
      </div>
    </main>
