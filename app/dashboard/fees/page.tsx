  ...
  return (
    <div className="p-4 md:p-8">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-xl md:text-2xl font-bold text-gray-800">Fees</h1>
            ...
            <table className="w-full min-w-[600px]">
              <thead className="bg-gray-50 border-b border-gray-100">
                <tr>
                  ...
                  <th className="text-left px-6 py-4 text-xs font-bold text-gray-400 uppercase hidden md:table-cell">Description</th>
              ...
              <tbody>
                {fees.map((fee: any, i: number) => (
                  <tr key={i} className="border-b border-gray-50 hover:bg-gray-50 transition">
                    ...
                    <td className="px-6 py-4 text-sm text-gray-500 hidden md:table-cell">{fee.description}</td>
                    <td className="px-6 py-4 text-sm font-bold text-gray-800">₦{fee.amount?.toLocaleString()}</td>
                    <td className="px-6 py-4 text-sm text-gray-500 hidden md:table-cell">{fee.term}</td>
