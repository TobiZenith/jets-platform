        ...
        <aside className="w-64 min-h-screen bg-white shadow-sm px-4 py-8 hidden md:block">
          ...
          <nav className="flex flex-col gap-1">
            {[
              ...
              { icon: "📢", label: "Announcements", href: "/dashboard/announcements", active: true },
        ...
        <div className="flex-1 p-8">
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <button
              ...
              className="bg-orange-500 text-white font-semibold px-6 py-2.5 rounded-full hover:bg-orange-600 transition text-sm">
              📢 New Announcement
            </button>
          </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm p-6 mb-8">
              ...
              <div className="flex flex-col gap-4">
                <div>
                  ...
                  <input name="title" onChange={handleChange} type="text" placeholder="e.g. School Closing Early Today"
                ...
                <div>
                  ...
                  <textarea name="content" onChange={handleChange} rows={4}
