  ...
  return (
    <main className="min-h-screen bg-gray-50">
      <nav className="bg-white shadow-sm px-8 py-4 flex items-center justify-between sticky top-0 z-50">
        ...
        <a href={`/dashboard/students/${id}`} className="text-sm text-gray-500 hover:text-blue-600 transition">
          ← Back to Student
        </a>
      </nav>
        ...
        <div className="flex-1 p-8">
          <div className="max-w-lg">
            <div className="mb-8">
              ...
              <p className="text-gray-400 text-sm mt-1">Update student information</p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm p-6">
              ...
              <div className="flex flex-col items-center mb-6">
                ...
                {photoUrl && <p className="text-xs text-green-500 mt-1">✅ Photo ready!</p>}
              </div>
              ...
              <div className="flex flex-col gap-4">
                ...
                <div>
                  ...
                  <input name="studentId" value={form.studentId} onChange={handleChange} type="text"
                    className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-blue-400 transition" />
                </div>
                <div>
